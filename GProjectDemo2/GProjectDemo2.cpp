...
// 唯一的一个 CGProjectDemo2App 对象

CGProjectDemo2App theApp;


// CGProjectDemo2App 初始化
...
void CGProjectDemo2App::TestDBConnect()
{
	...
	if(FAILED(hr))
	{
		::MessageBox(NULL,_T("对象指针实例化失败！"),_T("成功"),MB_OK);
		return;
	}
		try {
