...
void MakeGrid::makeGrid() {
	...
	double lonReduency=LONGIREDUENCY;
	double latReduency=LATIREDUENCY;
	minLongitude-=lonReduency;
	minLatitude-=latReduency;
	maxLongitude+=lonReduency;
	maxLatitude+=latReduency;
	//将边界点作为网格的左上方的点 
