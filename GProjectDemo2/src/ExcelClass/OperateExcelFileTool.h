#ifndef _OPERATEEXCELFILETOOL_H
#define _OPERATEEXCELFILETOOL_H
//OLE的头文件
#include "stdafx.h"
#include "CRange.h"
#include "CWorkbook.h"
...
///
///用于OLE的方式的EXCEL读写，
class OperateExcelFileTool
{
public:
	//构造函数和析构函数
	OperateExcelFileTool();
	virtual ~OperateExcelFileTool();
protected:
	///打开的EXCEL文件名称
...
public:
	...
	///检查一个CELL是否是浮点类型
	BOOL	IsCellDouble(long iRow,long iColumn);
	///得到一个CELL的String
	CString GetCellString(long iRow, long iColumn);
	CString GetCellStringPrecise(long iRow,long iColumn,int precise);
	///得到整数
